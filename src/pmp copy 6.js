...
//Display section
export function Cardbox({ queh, selectedValue, handleRadioChange, isCorrect }) {
        ...
        <Card sx={{ minWidth: 300, maxWidth: 750, margin: '0px 25%' }}>
            <CardContent>
                <FormControl>
                    ...
                    {/* Render message only if isCorrect is not null */}
                    {isCorrect !== null && (
                        console.log(isCorrect),
                        <p>{isCorrect==true ? 'Correct answer!' : 'Wrong answer...'}</p>
                    )}
